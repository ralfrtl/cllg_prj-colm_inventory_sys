...
Public Class frmDeletePermission
    ...
    Public Sub New(permissionDetails As PermissionDetails)
        ...
        lblIPermissionName.Text = "Name : " & permissionDetails.PermissionName
        btnCancel.Select()
    End Sub
    ...
    Private Async Function DeleteRecord() As Threading.Tasks.Task
        Try
            Using con As New SqlConnection(CONNECTION_STRING)
                con.Open()
                Using com As New SqlCommand("EXECUTE spDeletePermission @Key, @PermissionName", con)
                        ...
                        If reader.Read Then
                            Select Case reader("RES")
                                ...
                                Case "FK_tblUser_PermissionName"
                                    MessageBox.Show("This record is being reference by a record in user list.")
                                    Me.Close()
